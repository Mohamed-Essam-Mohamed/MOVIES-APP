...
import 'package:movies_app/src/feature/details/view_modle/details_view_model_cubit.dart';
...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<DetailsViewModelCubit, DetailsViewModelState>(
        bloc: viewModel..getDetailsMovies(movieId: arguments.id!),
  ...
  Padding _detailsMoviesWidget(DetailsViewModelSuccess state) {
    return Padding(
